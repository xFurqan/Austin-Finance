...
<aside class="left-sidebar" data-sidebarbg="skin6">
        <!-- Sidebar scroll-->
        <div class="scroll-sidebar ps-container ps-theme-default" data-ps-id="11c8a058-2eb0-89e9-60e8-e2799bd3ab6d">
            <!-- User profile -->
            <div class="user-profile position-relative" style="background: url(../public/assets/images/background/user-info.jpg) no-repeat;">
                <!-- User profile image -->
                <div class="profile-img"> <img src="http://admin-austin.designstalliondev.com/public/assets/images/users/profile.png" alt="user" class="w-100"> </div>
                <!-- User profile text-->
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://admin-austin.designstalliondev.com/customers" aria-expanded="false"><i class="mdi mdi-border-outside"></i><span class="hide-menu">Customers</span></a></li>
        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://admin-austin.designstalliondev.com/statistics" aria-expanded="false"><i class="mdi mdi-border-outside"></i><span class="hide-menu">Statistics</span></a></li>
        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="http://admin-austin.designstalliondev.com/home" aria-expanded="false"><i class="mdi mdi-border-outside"></i><span class="hide-menu">Instructions</span></a></li>
    </ul>
</nav>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="mb-0 text-white">Customer Detail</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> 0011 </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> Master </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Given Name:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> Michael </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> Keith </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">E-mail Address:</label>
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> michael_keith@elthamcollege.vic.edu.au </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> 612067 </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> w4tg </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <a href="{{url('adminChangeFinance')}}" type="submit" class="btn btn-danger"> <i class="fa fa-pencil"></i> Change Finance </a>
