    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">{{Auth::user()->name}}</h3>
                ...
                <div class="d-flex mt-2 justify-content-end">
                    <div class="d-flex mr-3 ml-2">
                        <div class="chart-text mr-2">
                            ...
                            <h4 class="mt-0 text-info">${{number_format($current_year, 2, '.', '')}}</h4>
                        </div>
                    ...
                    <div class="d-flex ml-2">
                        <div class="chart-text mr-2">
                            ...
                            <h4 class="mt-0 text-primary">${{number_format($last_year, 2, '.', '')}}</h4>
                        </div>
                        <div class="spark-chart">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-wrap">
                                <div>
                                    <h3 class="card-title">Yearly Status</h3>
                                    <h6 class="card-subtitle">Overview Yearly Campaign</h6>
                                </div>
                                <div class="ml-auto align-self-center">
                                    <ul class="list-inline mb-0">
                                        <li class="list-inline-item px-2">
                                            <h6 class="text-success"><i class="fa fa-circle font-10 mr-2 "></i>Current
                                                Year Amount</h6>
                                        </li>
                                        <li class="list-inline-item px-2">
                                            <h6 class="text-info"><i class="fa fa-circle font-10 mr-2"></i>Last
                                                Year Amount</h6>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="row text-center">
                                <div class="col-lg-4 col-md-4 mt-3">
                                    <h1 class="mb-0 font-weight-light">${{$com_withdrawals}}</h1><small>Total Withdrawal</small>
                                </div>
                                <div class="col-lg-4 col-md-4 mt-3">
                                    <h1 class="mb-0 font-weight-light">{{$total_accounts}}</h1><small>New Accounts </small>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <h6 class="card-subtitle text-white op-5">{{date('m/d/Y')}}</h6>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-4 align-self-center">
                                    <h2 class="font-weight-light text-white text-nowrap">${{number_format($com_totalAmount,2)}}</h2>
                                </div>
                    ...
                    <div class="card bg-success">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h3 class="card-title text-white">Total Accounts</h3>
                                    <h6 class="card-subtitle text-white op-5">{{date('Y-m-d')}}</h6>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col-4 align-self-center">
                                    <h2 class="font-weight-light text-white text-nowrap text-truncate">{{$total_accounts}}</h2>
                                </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card bg-info">
                        <div class="card-body">
                            ...
                            <div class="row my-2">
                                <div class="col-4 align-self-center">
                                <h2 class="font-weight-light text-white text-nowrap text-truncate">${{number_format($com_gainedInterest,2)}}</h2>
