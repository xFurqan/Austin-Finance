    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">{{$data->name}}</h3>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{url('customers/dashboard' , $data->id)}}">Home</a></li>
                ...
                <div class="col-12">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <div align="center">
                                <h3><span id="Label13" style="margin-right:40px; display:inline-block;font-size:Larger;font-weight:bold;height:40px;width:721px;">Welcome {{$data->name}} {{$data->surname}}
                                </span></h3>
                            </div>
                        </td>
                    </tr>
                        ...
                        <h2 class="card-title">History</h2>
                            ...
                            <div class="table-responsive">
                                <table  class="table table-striped table-bordered display">
                                    ...
                                    <tbody>
                                    @foreach($data->Finance as $cst)
                                    <tr>
                                        <td>{{$cst->date}}</td>
                                        <td>{{$cst->comments}}</td>
                                        <td>{{$cst->amount ? '$'.$cst->amount : NULL}}</td>
                                        <td>{{$cst->withdrawal ? '$'.$cst->withdrawal : NULL}}</td>
                                        <td>{{$cst->gained_interest  ? '$'.$cst->gained_interest : NULL}}</td>
                                        <td>{{$cst->current_amount  ? '$'.$cst->current_amount : NULL}}</td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                    ...
                    <div class="card">
                        ...
                        <h2 class="card-title">Financial Year</h2>
                            ...
                            <table  class="table table-striped table-bordered display ">
                                    ...
                                    @foreach($totalInterest as $int)
                                    @if($data->country == "america")
                                    <tr>
                                        <td>01/01/{{$int->year}} - 31/01/{{$int->year}} </td>
                                        <td>${{$int->total}}</td>
                                    </tr>
                                    @else
                                    <tr>
                                        <td>01/07/{{$int->year-1}} - 01/06/{{$int->year}}  </td>
                                        <td>${{$int->total}}</td>
                                    </tr>
                                    @endif
                                    @endforeach
