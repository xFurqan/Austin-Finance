                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static"> {{$data->account_number}} </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">  {{$data->account_title}} </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <p class="form-control-static">  {{$data->surname}} </p>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Sur name:</label>
                                                <div class="col-md-9">
                                                    <input class="form-control" name="surname" type="text" value="{{$data->surname}}">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
