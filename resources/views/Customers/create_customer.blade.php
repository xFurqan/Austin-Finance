    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Create Customer Table</h3>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form name="myform" method="POST" action="{{route('customers.store')}}" class="form-horizontal striped-rows b-form">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row border-bottom mb-0 py-3">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Account Number</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="account_number" value="{{isset($lastId) ? $lastId : NULL}}" placeholder="Account Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row border-bottom mb-0 py-3">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Given Name</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="name" value="{{old('name')}}"  placeholder="Last Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row border-bottom mb-0 py-3 bg-light">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Surname</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group row border-bottom mb-0 py-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" name="email" value="{{old('email')}}"   placeholder="Email Here">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="d-flex align-items-center justify-content-end">
                                            <label for="inputEmail3" class="control-label col-form-label">Country</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                    ...
                                    <div class="form-group row mb-0 py-3 bg-light">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Login ID</label>
                                            </div>
                                        </div>
                                         <div class="col-sm-9">
                                        <input type="hidden" name="loginlength" value="6">
                                        <input name="login" type="text" size="40">&nbsp;
                                        <input type="button" class="btn btn-info btn-sm" value="Generate Login" onClick="generateLogin();" tabindex="2">
                                        </div>
                                        <script>
                                        function randomLogin(length) {
                                        ...
                                        function generateLogin() {
                                            myform.login.value = randomLogin(myform.loginlength.value);
                                        }
                                    </script>
                                    </div>
                                    <div class="form-group row mb-0 py-3 bg-light">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3"  class="control-label col-form-label">Interest Rate</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="1.12" name="interest_rate" value="{{old('interest_rate')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row border-bottom mb-0 py-3">
                                    ...
                                    <input type="button" class="btn btn-info btn-sm" value="Generate Password" onClick="generate();" tabindex="2">
                                    </div>
                                    <script>
                                ...
                                <div class="form-group row border-bottom mb-0 py-3">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check mr-sm-2">
                                            <input type="checkbox" class="form-check-input" id="sf1" name="joint_account"  value="check" style="display:none;">
                                            <label class="form-check-label" for="sf1">Joint Acccount</label>
                                        </div>
                                ...
                                <div class="class-for-show">
                                    <div class="form-group row border-bottom mb-0 py-3 bg-light">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Joint Account Title</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="joint_account_title" value="{{old('joint_account_title')}}"  placeholder="Title">
                                        </div>
                                    </div>
                                    <div class="form-group row border-bottom mb-0 py-3">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Joint Account Given Name</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="joint_account_given_name" value="{{old('joint_account_given_name')}}" placeholder="Last Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row border-bottom mb-0 py-3 bg-light">
                                        <div class="col-sm-3">
                                            <div class="d-flex align-items-center justify-content-end">
                                                <label for="inputEmail3" class="control-label col-form-label">Joint Account Surname</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="joint_account_surname" value="{{old('joint_account_surname')}}" placeholder="Surname">
                                        </div>
                                    </div>
                                </div>
