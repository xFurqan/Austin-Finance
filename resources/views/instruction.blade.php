    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">Instructions</h3>
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                <div class="ms-2 align-self-center">
                                    <p>
                                        To change the interest rate for an account, log into Admin, select the account and go to the 'Finance' page. In the drop down menu in the 'type' section, select 'Interest Changed', type the multiplication (1.1 for 10%), enter the date the change is supposed to occur and press 'Update'. If there is an error saying interest rate is the same, then it's detecting that for that date, the interest rate was already set to the rate you are trying to set it to. You will need to go into the 'Database Controller' page, select the 'Changed Interest' database and find the entry for that account ID that has a date BEFORE the one you tried to set it to. This should read the same interest rate that you are trying to enter, so remove it. After that, proceed with trying to set the appropriate interest rate again.
If you have an issue with the dates, ie, the dates are out of order or you have a negative interest deposit, chances are most likely that it's finding a 'Changed Interest' entry earlier than the time of the first deposit.
                                    </p>
                                </div>
                            </div>
                        </div>
