                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ms-2 align-self-center">
                                    <h3 class="mb-0">${{number_format($aus_com_amount ,2)}}</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ms-2 align-self-center">
                                    <h3 class="mb-0">${{number_format($aus_com_withdrawals,2)}}</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ms-2 align-self-center">
                                    <h3 class="mb-0">${{number_format($aus_com_gainedInterest,2)}}</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row">
                                ...
                                <div class="ms-2 align-self-center">
                                    <h3 class="mb-0">${{number_format($aus_total,2)}}</h3>
